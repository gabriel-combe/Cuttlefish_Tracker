...
L'intelligence artificielle utilise le code et les poids pré-entrainés de YOLOv7\cite{wang_yolov7_nodate}, qui peuvent être trouvés sur le github officiel de YOLOv7\cite{yolov7_github}.
