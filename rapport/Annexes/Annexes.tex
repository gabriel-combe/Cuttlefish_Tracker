...
\begin{figure}[!htbp]
	...
	\caption{Diagramme UML des classes globales (\href{https://github.com/gabriel-combe/PP2_Particle_Filter/blob/test/rapport/UML/classes.svg}{lien vers l'image SVG}, zoomer sur l'image SVG pour avoir plus de détaille).}
...
\begin{figure}[!htbp]
	...
	\caption{Diagramme UML de la classe Similarity (\href{https://github.com/gabriel-combe/PP2_Particle_Filter/blob/test/rapport/UML/similarity.svg}{lien vers l'image SVG}, zoomer sur l'image SVG pour avoir plus de détaille).}
...
\begin{figure}[!htbp]
	...
	\caption{Diagramme UML de la classe ParticleFilter (\href{https://github.com/gabriel-combe/PP2_Particle_Filter/blob/test/rapport/UML/particlefilter.svg}{lien vers l'image SVG}, zoomer sur l'image SVG pour avoir plus de détaille).}
